...
|---------|---------|--------|---------------------------|
| **🎯 Flight Orchestrator** | `fh_flight` | 2 | Identificación única, control de ciclo de vida, mensajes |
...
2. ✅ **26 tablas organizadas** con prefijos consistentes `fh_*`
